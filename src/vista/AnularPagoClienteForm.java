...
public class AnularPagoClienteForm extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form AnularPagoCliente
    ...
    FacturaCabeceraVentaControlador ventaC = new FacturaCabeceraVentaControlador();
    ...
    public AnularPagoClienteForm() throws Exception {
        initComponents();
        getClientes();
     ...
     private void getReciboCliente(Integer idCli) {
        try {
            modeloBusquedaFacturas.setColumnCount(0);
            modeloBusquedaFacturas.setRowCount(0);
           
            try (ResultSet rs = reciboControlador.recibosCliente(idCli)) {
    ...
    private void cancelar(){
      ...
      private void establecerBotones(String modo) {
        ...
        private void guardar() throws ParseException, Exception{
            ...
            showMessageDialog(null, "Debe ingresar la cedula del cliennte", "Atención", INFORMATION_MESSAGE);
            txtCliente.requestFocusInWindow();
            return;
        } else if ("".equals(txtCliente1.getText())) {
            showMessageDialog(null, "El nombre del cliente no puede quedar vacio", "Atención", INFORMATION_MESSAGE);
             ...
             reciboControlador.updateFechaAnulacion(idRecibo, date);
                while (f<tbVistaFacturasPendientes.getRowCount()){
                    if(tbVistaFacturasPendientes.isRowSelected(f)) {          
                        ...
                        factpendienteModel.setClienteId(cliC.devuelveId(txtCliente.getText().replace(".", "").trim()));
                 ...
                 if (esContado.equals("CONTADO")){
                            ventaC.updateEstado(nroFactura);
                        }else{
    ...
    private void cargarCuotasPagadas(int factura) {
        ...
        try {
            ...
            try (ResultSet rs = facturaPendienteControl.getCuotasPagadasCli(factura)) {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Anulacion Pago Cliente");
        setToolTipText("");
        ...
        jPanel1.add(txtCliente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 220, -1));
        ...
        jPanel1.add(txtCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 110, 80, -1));
    ...
    jLabel5.setText("ANULACION PAGO CLIENTE");
   ...
   if (evt.getKeyCode() == KeyEvent.VK_ENTER) { 
            if ("*".equals(txtNroRecib.getText())) {
              if ("".equals(txtCliente.getText())){ 
                ...
                bf.order = "fecha DESC";
                bf.filtroBusqueda = "cliente_id= "+ cli+ " and fecha_anulacion is null";
                bf.setLocationRelativeTo(this);
                bf.setVisible(true);
                ...
                for(int c=0; c<modeloBusquedaFacturas.getRowCount(); c ++){
                    if (modeloBusquedaFacturas.getValueAt(c, 0).toString().equals(bf.retorno)){
                        ...
                        try {
                            ...
                            Logger.getLogger(ReciboClienteForm
