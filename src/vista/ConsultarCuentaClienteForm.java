 ...
 * @author Pathy
 */
public class ConsultarCuentaClienteForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form ConsultarFacturaVentaForm
     */
    public ConsultarCuentaClienteForm() {
        initComponents();
        getCliente();
    ...
    DefaultTableModel modeloTablaCuenta = new DefaultTableModel();
     ...
     private void getCuenta(int codigoCliente) {
        try {
            ...
            try (ResultSet rs = cuentaControlador.consultarCuentaCliente(codigoCliente)) {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Consultar Cuentas de Clientes");
        ...
        jLabel1.setText("CONSULTAR CUENTAS DE CLIENTES");
