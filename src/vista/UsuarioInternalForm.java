 ...
 * @author Pathy
 */
public class UsuarioInternalForm extends javax.swing.JInternalFrame {
    ...
    private void guardar() {
        if (showConfirmDialog(null, "Está seguro de guardar los datos?", "Confirmar", YES_NO_OPTION) == YES_OPTION) {
            ...
            try {
                ...
                Logger.getLogger(UsuarioInternalForm.class.getName()).log(Level.SEVERE, null, ex);
            }
