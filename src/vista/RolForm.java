...
public class RolForm extends javax.swing.JInternalFrame {
    ...
    private void guardar(){
       ...
       if (txtDescripcionRol.getText().trim().isEmpty() == true) {
            showMessageDialog(this, "Campo descripción vacío, por favor ingrese la descripción del rol", "", JOptionPane.WARNING_MESSAGE);
            return;
        } 
    ...
    private void TbRolMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TbRolMouseClicked
        if(txtDescripcionRol.isEnabled() == false){
            evt.consume();
        }else{
