 ...
 * @author Pathy
 */
public class AnularInternalForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form AnularInternalFrame
     */
    public AnularInternalForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtFechaVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 140, 160, -1));
        ...
        jPanel1.add(txtPrefijo, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 110, 76, -1));
        ...
        jLabel3.setText("Monto total de factura");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 220, -1, 20));
        jPanel1.add(txtTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 180, 160, -1));
        ...
        jPanel1.add(txtTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 220, 160, -1));

        jLabel1.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 11)); // NOI18N
        jLabel1.setText("Número de factura a anular");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 170, 20));
        jPanel1.add(txtNroFactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 110, 70, -1));
        ...
        jLabel5.setText("ANULAR FACTURA");
    ...
    private void txtPrefijoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPrefijoKeyPressed
         if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if ("*".equals(txtPrefijo.getText())) {
                ...
                bf.columnas = "nro_prefijo as \"Nro Prefijo\", nro_factura as \"Nro Factura\", to_char(fecha,'dd/mm/yyyy') as \"Fecha\", pago_contado as \"Forma de pago\", precio_total as \"Total\"";
                bf.tabla = "Venta";
                bf.order = "venta_id";
                bf.filtroBusqueda = "";
    ...
    private void anular() {
        ...
        if(showConfirmDialog (null, "Está seguro de anular la factura?", "Confirmar", YES_NO_OPTION) == YES_OPTION){ 
            ...
            try {
                ...
                showMessageDialog(null, "Factura anulada correctamente");
            } catch (Exception ex) {
                Logger.getLogger(AnularInternalForm.class.getName()).log(Level.SEVERE, null, ex);
            }
            limpiar();
            txtPrefijo.setBackground(Color.yellow);
        }   
