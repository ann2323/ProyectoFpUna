 ...
 * @author anex
 */
public class DetallePagoForm extends javax.swing.JInternalFrame {
 ...
 public DetallePagoForm() throws Exception {
        initComponents();
        getFacturaCompra();
        ...
        txtPendiente.setText(FacturaCompraForm.txtTotal.getText());
        txtPagado.setText("0");
        txtCambio.setText("0");
  ...
  private void getFacturaCompra() {
    ...
    private void initComponents() {
        ...
        jPanelTarjeta.add(txtAutorizacionTarjeta, new org.netbeans.lib.awtextra.AbsoluteConstraints(128, 58, 140, 28));

        jLabel3.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 11)); // NOI18N
        jLabel3.setText("Autorizacion:");
        jPanelTarjeta.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 63, -1, -1));
            ...
            .addGroup(jPanelNotaCreditoLayout.createSequentialGroup()
                ...
                .addGroup(jPanelNotaCreditoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelNotaCreditoLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(JCfactura, 0, 200, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void jBGuardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuardar1ActionPerformed
        FacturaCompraForm.tbDetallePagoCompra.setModel(modeloPago);
    ...
    private void jBCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCancelarActionPerformed
       ...
       if(tbDetallePago.getSelectedRow() == -1){
            ...
            if (Integer.parseInt(txtPagado.getText().trim().replace(".", ""))<Integer.parseInt(FacturaCompraForm.txtTotal.getText().replace(".", "").trim()) && pendiente!=0){
            ...
            }else if (Integer.parseInt(txtPagado.getText().trim().replace(".", ""))==Integer.parseInt(FacturaCompraForm.txtTotal.getText().replace(".", "").trim())){
            pendiente=0;
            String PendienteFormat=formateadorDelet.format(pendiente);
            txtPendiente.setText(PendienteFormat);
            }else if (Integer.parseInt(txtPagado.getText().trim().replace(".", ""))<Integer.parseInt(FacturaCompraForm.txtTotal.getText().replace(".", "").trim()) && pendiente==0){
            pendiente=Integer.parseInt(FacturaCompraForm.txtTotal.getText().replace(".", "").trim())-Integer.parseInt(txtPagado.getText().trim().replace(".", ""));
            String PendienteFormat=formateadorDelet.format(pendiente);
            txtPendiente.setText(PendienteFormat);
            }
            ...
            if (Integer.parseInt(FacturaCompraForm.txtTotal.getText().trim().replace(".", ""))<=Integer.parseInt(txtPagado.getText().replace(".", "").trim())){
            cambio=Integer.parseInt(txtPagado.getText().replace(".", "").trim())-Integer.parseInt(FacturaCompraForm.txtTotal.getText().trim().replace(".", ""));
            ...
            total=0; cambio=0;
            pendiente=Integer.parseInt(FacturaCompraForm.txtTotal.getText().trim().replace(".", ""));
            String PendienteFormat=formateadorDelet.format(pendiente);
            txtPendiente.setText(PendienteFormat);
            }
    ...
    private void bNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bNuevoActionPerformed
       if (!"".equals(txtValor.getText())){
        ...
        if (JCtipoPago.getSelectedItem().toString().equals("Nota de Credito")){
            ...
            datos[6]=JCfactura.getSelectedItem().toString();
            modeloPago.addRow(datos);   
        }
        tbDetallePago.setModel(modeloPago);
        txtValor.setText("");
        ...
        pendiente=Integer.parseInt(FacturaCompraForm.txtTotal.getText().replace(".", "").trim());
        }
        if (total< Integer.parseInt(FacturaCompraForm.txtTotal.getText().replace(".", "").trim())){
        pendiente=Integer.parseInt(FacturaCompraForm.txtTotal.getText().replace(".", "").trim())- total;
        String PendienteFormat=formateador.format(pendiente);
        txtPendiente.setText(PendienteFormat);
        }else{
        cambio=total-Integer.parseInt(FacturaCompraForm.txtTotal.getText().replace(".", "").trim());
