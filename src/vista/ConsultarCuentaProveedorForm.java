 ...
 * @author Pathy
 */
public class ConsultarCuentaProveedorForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form ConsultarFacturaVentaForm
     */
    public ConsultarCuentaProveedorForm() {
        initComponents();
        getProveedor();
    ...
    CuentaCabeceraControlador cuentaControlador = new CuentaCabeceraControlador();
    DefaultTableModel modeloTablaCuenta = new DefaultTableModel();
     ...
     private void getCuenta(int codigoProveedor) {
        try {

            tbCuenta.setModel(modeloTablaCuenta);

            modeloTablaCuenta.setRowCount(0);
            modeloTablaCuenta.setColumnCount(0);

            try (ResultSet rs = cuentaControlador.consultarCuentaProveedor(codigoProveedor)) {
                ...
                for (int i = 1; i <= cantidadColumnas; i++) {
                    modeloTablaCuenta.addColumn(rsMd.getColumnLabel(i));
                }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Consultar Cuentas de Proveedores");
        ...
        jLabel1.setText("CONSULTAR CUENTAS DE PROVEEDORES");
        ...
        tbCuenta.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        tbCuenta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Saldo total de la cuenta", "Estado de la cuenta"
            }
        ));
        tbCuenta.setEditingRow(0);
